...
const P = [
  ...
  { id: "P006", titulo: "Eleitora de esquerda conservadora nos costumes",
    ...
    esperado: { deveLiderar: ["C05", "C10"], naoPodeLiderar: ["C01", "C02", "C03", "C04", "C06", "C08"],
                deveEliminar: [], deveEmpatar: ["C05", "C10", "C11", "C12", "C09"],
                deveSinalizar: [], semAssercao: ["C07"] },
    justificativa: "PERFIL ADVERSARIAL. Cinco líderes dentro da margem com afinidades DISTINTAS (0,947 a 0,914) — é o cenário mais sensível a mutação que este corpus produz: remover uma postura ou dobrar um peso reordena a lista. Perfis confortáveis, em que um candidato domina, não detectam nada (§25.3). Note o contraste de cobertura entre o líder (0,31) e quem vem logo atrás (0,77)." },
